...
class KnapsackBenchmark:
    ...
    def __init__(self, problems: List[str], timelimit: int = 60, solver_types: List[SolverType] = list(SolverType), print_function: Callable = print, problems_dir: str = "knapsack_problems"):
    ...
    def run(self):
        ...
        for (i,p) in enumerate(self.problems):
            ...
            solvers = [SolverFactory.solver(st, problem=problem, timelimit=self.timelimit) for st in self.solver_types]
